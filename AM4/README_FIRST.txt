AM4 TWO-ESP32 ARCHITECTURE - LINK FIXED
=======================================
...
The code has AM4_LINK_DEBUG enabled, so every connection stage and JSON packet
is printed. After commissioning, set AM4_LINK_DEBUG to 0 in both
