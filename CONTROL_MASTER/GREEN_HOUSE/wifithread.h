...
void DEVICE_INIT() {
  ...
  userSetHumidity = preferences.getUInt("userSetHumidity", 50);
...
bool mainControlChanged = false;  // Flag to track if main_control changed
  ...
  // if (doc.containsKey("maincontrol") && doc["maincontrol"].as<int>() != main_control) {
  //   main_control = doc["maincontrol"].as<int>();
  //   preferences.putBool("main_control", main_control);
  // }


  // if (doc.containsKey("fancontrol") && doc["fancontrol"].as<int>() != fan_control) {
  //   fan_control = doc["fancontrol"].as<int>();
  ...
  if (doc.containsKey("humiditySp") && doc["humiditySp"].as<int>() != userSetHumidity) {
    // humiditySp = doc["humiditySp"].as<int>();
    userSetHumidity = doc["humiditySp"].as<int>();
    preferences.putUInt("sp", userSetHumidity);
  }
  // if (doc.containsKey("fansw") && doc["fansw"].as<int>() != fansw) {
  //   fansw = doc["fansw"].as<int>();
  ...
  // Serial.print("humiditySp: ");
  // Serial.println(humiditySp);
...
void publishJson() {
  ...
  doc["temp"] = String(temperatureC,1);
  doc["humidity"] = String(humidity);
  doc["humiditySp"] = String(userSetHumidity);
  ...
  // {"maincontrol":"0","temp":"31.9","humidity":"34.0","humiditySp":"40","pumpcontrol":"0","pumpsw":"1","pumpstate":"0","mac_address":"00:4B:12:3B:DF:CC","ip_address":"192.168.1.63","ssid":"BETA DEV","password":"xttok2fb"}


  // {
  //   "maincontrol": "0", // for power
  //   "fancontrol": "0", // for fan auto manual
