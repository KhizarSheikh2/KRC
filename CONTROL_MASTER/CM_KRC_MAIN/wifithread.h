...
void DEVICE_INIT() {
  ...
  fan_control = preferences.getBool("fan_control", false);
...
void Extract_by_json(String incomingMessage) {
  ...
  if (doc.containsKey("temp1sp") && doc["temp1sp"].as<int>() != sp) {
    temp1sp = doc["temp1sp"].as<int>();
    sp = doc["temp1sp"].as<int>();
  ...
  // Serial.print("temp1sp: ");
  // Serial.println(temp1sp);
