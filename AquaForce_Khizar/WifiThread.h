...
bool message_received_temp_config = false;
bool message_received_temp_configB = false;
bool message_received_configA = false;
bool message_received_configB = false;
