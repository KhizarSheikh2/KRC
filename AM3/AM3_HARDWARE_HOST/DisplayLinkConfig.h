...
// These values must exactly match AM3_DISPLAY/DisplayLinkConfig.h.
...
constexpr uint32_t AM3_DISPLAY_STATE_INTERVAL_MS = 500;
constexpr uint32_t AM3_DISPLAY_CLIENT_TIMEOUT_MS = 15000;
constexpr uint32_t AM3_HOST_AP_HEALTH_CHECK_MS = 5000;
constexpr uint32_t AM3_HOST_LINK_STATUS_INTERVAL_MS = 5000;

constexpr size_t AM3_DISPLAY_RX_BUFFER_SIZE = 512;
constexpr size_t AM3_DISPLAY_TX_BUFFER_SIZE = 1280;
