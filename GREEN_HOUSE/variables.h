...
String Name = "GREEN_HOUSE";
String devicename = "DM-AAA001";
// password : bitahomes
...
bool tmp_req = true;
String temp1 = "0";
int PUMP_CONTROL_PIN = 17;
bool pumpstate = false; //pump state
uint8_t pumpsw = 0;   
int pump_control = 0;


//pump_control; (auto at 1 and manual at 0 give from app side)
//humiditySp:"16","maincontrol":true,"pumpcontrol":false,"pumpsw":false}
